            ...
            if event == "button_migrate":
                if new_player_selection_index == None or old_player_selection_index == None or old_player_selection_index == new_player_selection_index:
                    ...
                    if popup_return == "OK":
                        ...
                        new_sav_path = os.path.join(player_folder_path, f"{new_player_guid}.sav")
                        player_sav_path = os.path.join(player_folder_path, f"{old_player_guid}.sav")
                        ...
                        if not os.path.exists(player_sav_path):
                            sg.popup(f"ERROR: The old player .sav file at {player_sav_path} does not exist.", text_color='lightcoral')                   
                    
                        elif not os.path.exists(new_sav_path):
                            sg.popup(f"ERROR: The new player .sav file at {new_sav_path} does not exist.", text_color='lightcoral')
